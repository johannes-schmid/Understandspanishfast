...
export default function LevelTest() {
  ...
  return (
    <div className="bg-background text-on-surface">
      <SEO title="Check Your Spanish Level — Word Reach Test" description="Take the 2-minute Word Reach test to find your Spanish vocabulary level and see what content you can unlock." canonical="/level-test" />
            ...
            {!done ? (
              <>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button onClick={() => answer(false)} className="flex items-center justify-center gap-2 bg-surface-container-highest text-on-surface-variant py-5 rounded-full font-semibold border-2 border-transparent hover:border-outline-variant transition-all active:scale-[0.98]">
                    <span className="material-symbols-rounded">close</span>
                    Not yet
                  </button>
                  <button onClick={() => answer(true)} className="flex items-center justify-center gap-2 bg-primary-container text-on-primary-container py-5 rounded-full font-semibold shadow-sm hover:brightness-105 transition-all active:scale-[0.98]">
              ...
              <>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <button onClick={restart} className="flex-1 bg-surface-container-highest text-on-surface-variant py-4 rounded-full font-semibold hover:brightness-95 transition-all">
                    Retake test
                  </button>
                  <Link to="/words/most-common-spanish-words" className="flex-1 text-center bg-primary-container text-on-primary-container py-4 rounded-full font-semibold shadow-sm hover:brightness-105 transition-all no-underline">
