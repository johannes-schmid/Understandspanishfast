        ...
        <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="z-10 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-6 mb-6">
              ...
              <Link to="/level-test" className="bg-white border-2 border-slate-200 text-slate-700 px-10 py-5 rounded-full font-semibold text-lg hover:border-[#FF8C00] hover:text-[#FF8C00] transition-all no-underline">
                Test Your Level
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-8 text-center">
          <div className="bg-slate-950 rounded-[2rem] py-24 px-8 text-white relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <Link to="/level-test" className="inline-block soft-gradient-orange text-white px-12 py-5 rounded-full font-semibold text-xl hover:scale-105 transition-all shadow-2xl shadow-orange-500/20 no-underline">
                Test Your Level
              </Link>
            </div>
          </div>
